...
htmls = []
page_nums = list(range(2, 6))  # 精品，一共13页
...
words = ['学习一下，多谢楼主分享！！！', '看起来很不错的样子，GOOD！', '看来我要努力赚钱了！',
         '楼主真是个大好人，谢谢了！', '我想下载这个游戏……', '好，这个太好了，下载看看学习哈',
         '这个看起来非常完整啊，顶一个！', '我的征途是星辰大海……', '升职CEO，迎娶白富美就靠它了！！！',
         '谢谢，好东东就应该是分享，哈哈哈', '很不错,非常值得学习，楼主威武！！！', '感谢分享！！！你的分享是我们前进的方向^']
